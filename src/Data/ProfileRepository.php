...
/**
 * Profile CRUD implementation for {@see \LowlyPHP\Service\Api\RepositoryInterface}.
 */
class ProfileRepository implements RepositoryInterface, StatisticRepositoryInterface
{
    ...
    public function stat(RepositorySearchInterface $criteria) : StatisticEntityInterface
    {
        ...
        $reference = $this->profileFactory->create();
