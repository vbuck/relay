...
/**
 * Condition-based action for environment variables.
 */
class EnvironmentVariable extends AbstractCondition implements TypeInterface
{
    /** @var ResultFactory */
    ...
    public function __construct(
        ...
        string $defaultType = 'environment_variable'
    ) {
    ...
    public function process(
        ...
        $expectedValue = (string) $_ENV[$parameters[static::PARAMETER_KEY]->getId()] ?? '';
