...
/**
 * Condition-based action for web server variables.
 */
class ServerVariable extends AbstractCondition implements TypeInterface
{
    /** @var ResultFactory */
    ...
    public function __construct(
        ...
        string $defaultType = 'server_variable'
    ) {
    ...
    public function process(
        ...
        $expectedValue = (string) $_SERVER[$parameters[static::PARAMETER_KEY]->getValue()] ?? '';
