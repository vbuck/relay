...
/**
 * Condition-based action for request parameters.
 */
class Request extends AbstractCondition implements TypeInterface
{
    /** @var ResultFactory */
    ...
    public function process(
        ...
        $expectedValue = (string) $request->getParameter($parameters[static::PARAMETER_KEY]->getValue());
